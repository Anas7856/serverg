...
const EMAIL_CONFIG = {
  ...
  toEmail: process.env.TO_EMAIL || 'Henry@vallhallalogisticllc.com'
};
    ...
    <div class="container">
        ...
        <div class="footer">
            ...
            <div class="contact-info">
                <div>📞 Phone: 4832475857845 | ✉️ Email: Henry@vallhallalogisticllc.com</div>
...
Phone: 03447732310 | Email: Henry@vallhallalogisticllc.com
...
Phone: 03447732310
Email: Henry@vallhallalogisticllc.com
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="margin-top: 30px; padding: 20px; background: #dbeafe; border-radius: 8px; text-align: center;">
                <h4>Contact Us</h4>
                <p>Phone: 03447732310<br>Email: Henry@vallhallalogisticllc.com</p>
            </div>
        </div>
    </div>
</body>
